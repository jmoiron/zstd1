...
*
*  ZBUFF1_compressFlush() can be used to instruct ZBUFF to compress and output whatever remains within its buffer.
...
{
    if (pledgedSrcSize==0) pledgedSrcSize = ZSTD1_CONTENTSIZE_UNKNOWN;  /* preserve "0 == unknown" behavior */
